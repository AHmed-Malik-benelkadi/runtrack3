function jourtravaille(date) {
    const joursFeries = [
        new Date(2021, 0, 1), // Les mois commencent à 0 donc 0 = janvier, 1 = février, etc.
        new Date(2021, 3, 13),
        new Date(2021, 3, 12),
        new Date(2021, 4, 1),
        new Date(2021, 4, 8),
...
jourtravaille(new Date(2021, 11, 25));
jourtravaille(new Date(2021, 11, 26));
jourtravaille(new Date(2021, 11, 27));